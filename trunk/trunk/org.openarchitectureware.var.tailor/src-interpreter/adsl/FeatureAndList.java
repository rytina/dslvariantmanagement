 ...
 * <ul>
 *   <li>{@link adsl.FeatureAndList#getFeatureList <em>Feature List</em>}</li>
 * </ul>
 * </p>
 *
 * @see adsl.AdslPackage#getFeatureAndList()
 * @model
 * @generated
 */
public interface FeatureAndList extends FeatureClause {
   ...
   * @see adsl.AdslPackage#getFeatureAndList_FeatureList()
