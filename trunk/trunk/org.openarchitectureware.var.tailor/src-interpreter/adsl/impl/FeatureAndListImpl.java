 ...
 * <ul>
 *   <li>{@link adsl.impl.FeatureAndListImpl#getFeatureList <em>Feature List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeatureAndListImpl extends FeatureClauseImpl implements FeatureAndList {
  ...
  protected EClass eStaticClass() {
    return AdslPackage.Literals.FEATURE_AND_LIST;
  }
  ...
  public EList<String> getFeatureList() {
    if (featureList == null) {
      featureList = new EDataTypeEList<String>(String.class, this, AdslPackage.FEATURE_AND_LIST__FEATURE_LIST);
    }
    return featureList;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case AdslPackage.FEATURE_AND_LIST__FEATURE_LIST:
