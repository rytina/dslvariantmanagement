 ...
 * <ul>
 *   <li>{@link org.openarchitectureware.var.features.features.impl.OrExpressionImpl#getOperands <em>Operands</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrExpressionImpl extends MinimalEObjectImpl.Container implements OrExpression
{
  ...
  {
    return FeaturesPackage.Literals.OR_EXPRESSION;
  }
  ...
  public EList<AndExpression> getOperands()
  {
    if (operands == null)
    {
      operands = new EObjectContainmentEList<AndExpression>(AndExpression.class, this, FeaturesPackage.OR_EXPRESSION__OPERANDS);
    }
    return operands;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case FeaturesPackage.OR_EXPRESSION__OPERANDS:
